...
: ?trigger-job ( -- )
    ...
    if
        ECM-start-ch-slv ec-din@        \ control panel 上的 start 按鍵
        if
            panel-start trigger-job !
            exit
        then
        ECM-pause-ch-slv ec-din@        \ control panel 上的 pause 按鍵
        if
            panel-pause trigger-job !
            exit
        then
        ECM-reset-ch-slv ec-din@        \ control panel 上的 reset 按鍵
        if
            ...
            case
                ...
                2 of
                    ...
                    if
                        ...
                        ECM-start-ch-slv ec-din@ not    \ 若已放開按鍵
                        if
                ...
                3 of
                    ECM-motion-state @ idle <>  \ 若 motion not idle
                    ECM-start-ch-slv ec-din@ not or \ 或按鍵已放開
                    if
            ...
            case
                ...
                2 of
                    ...
                    if
                        ...
                        ECM-pause-ch-slv ec-din@ not    \ 若已放開按鍵
                        if
                            0 trigger-step !                \ 清除 trigger step 以離開 trigger forth
                        then
                    then
            ...
            case
                ...
                2 of
                    ...
                    if
                        ...
                        ECM-reset-ch-slv ec-din@ not    \ 若已放開按鍵
                        if
                            0 trigger-step !                \ 清除 trigger step 以離開 trigger forth
                        then
                    then
        ...
        remoter-start of
            ...
            case
                ...
                2 of
                    ...
                    ECM-motion-state @ idle <> or \ 或 motion not idle 
                    if
                        panel-start-triggered off   \ 關閉 panel start triggered 旗標
                        0 trigger-step !            \ 清除 trigger step 以離開 trigger forth
                    then
