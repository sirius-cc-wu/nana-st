...
create axis-psl falign 5 floats allot

\ axis negative software limit
create axis-nsl falign 5 floats allot

\ axis software limit enabled
\ TODO: defaut to $FF
create axis-sl-enabled here 5 cells dup allot $0 fill
...
\ ===== ECM 軟體極限設定 =====
\ X, Y, Z
1 314.5e mm axis-psl!
1 11.5e mm axis-nsl!
1 +axis-sl

2 121.5e mm axis-psl!
2 18.5e mm axis-nsl!
2 +axis-sl
